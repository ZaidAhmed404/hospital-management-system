            ...
            <li class="nav-item">
                ...
                <div id="collapse1" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ route ('user.view') }}">Add</a>
                    </div>
                </div>
            </li>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                           <form action="{{ route ('user.add') }}"  method="post">
                            ...
                            <div class="form-group row">
                                <label for="staticEmail" class="col-sm-2 col-form-label">Email<sup class="star">*</sup></label>
                                <div class="col-sm-8">
                                <input placeholder="Enter the Email" class="form-control"  id="email" name="email" maxlength="40" type="text" required>
                                    </div>
                              </div>
                            <div class="form-group row">
                                <label for="staticEmail" class="col-sm-2 col-form-label">Roles<sup class="star">*</sup></label>
                                <div class="col-sm-8">
                                            
                            <select class="form-select" aria-label="Default select example" name="role" id="role">
                                <option value="Doctor">Doctor</option>
                                
                                <option value="Sub Doctor">Sub-Doctor</option>
                             ...
                             <div class="form-group row">
                                <label for="staticEmail" class="col-sm-2 col-form-label">Password<sup class="star">*</sup></label>
                                <div class="col-sm-8">
                                <input placeholder="Enter the Password" class="form-control" maxlength="30" id="password" name="password"  type="text" required>
                                    </div>
                              </div>
                            <br><br>
                                  <center>
