            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ route ('patient.check') }}">Check</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Check Patient</h1>
                    
                    <div class="card shadow mb-4">
                        
                        <div class="card-body">
                           <form action="{{ route ('checkPatient.post',$Patient->id) }}"  method="post">
                                    @csrf
                                
                                    <div class="form-group row">
                                <label for="staticEmail" class="col-sm-2 col-form-label">Name<sup class="star">*</sup></label>
                                <div class="col-sm-8">
                                <input placeholder="Enter the Name" class="form-control" value='{{$Patient->name}}'  id="name" name="name"  type="text" maxlength="40" required>
                                    </div>
                              </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                <input placeholder="Enter the Regt.Number" class="form-control" value='{{$Patient->regtNumber}}'  id="regtNumber" name="regtNumber" maxlength="40" type="text" required>
                                    </div>
                              </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                <input placeholder="Enter the Unit" class="form-control"  id="unit" value='{{$Patient->unit}}' name="unit" maxlength="40" type="text" required>
                                    </div>
                              </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                <input placeholder="Enter the Rank" class="form-control"  id="rank" name="rank" value='{{$Patient->rank}}' maxlength="40" type="text" required>
                                    </div>
                              </div>
