            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                        <form action="{{ route ('medicine.give',$Patient->id) }}" method="post">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                <label for="inputPassword4">Issued</label>
                                <select class="form-select" aria-label="Default select example" name="medicine[][{{$prescription->id}}]" id="medicine">
                            ...
                            <hr>  
                             @endforeach
                                  ...
                                  <div class="form-group">
                                <label for="inputAddress">Diagnosis</label>
                                <input type="text" class="form-control" id="inputAddress" placeholder="{{$remark->referredTo}}" readonly>
                            </div>
                            <hr>  
                             @endforeach
