            ...
            <li class="nav-item">
                ...
                <div id="collapse" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ route ('medicines.show') }}">Reports</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Edit Medicine</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                           <form action="{{ route ('medicine.edit',$Medicine->id) }}"  method="post">
                                ...
                                <div class="col-sm-8">
                                <input placeholder="Enter the Medicine Name" class="form-control" value='{{$Medicine->name}}'  id="name" name="name"  type="text" maxlength="40" required>
                                    </div>
                              </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                <input placeholder="Enter the Medicine Type" class="form-control" value='{{$Medicine->medicineType}}' id="medicineType" name="medicineType" maxlength="40" type="text" required>
                                    </div>
                              </div>
                            <div class="form-group row">
                            ...
                            <select class="form-select" aria-label="Default select example" name="purchaseType" id="purchaseType">
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                <input placeholder="Enter the Medicine Quantity" value='{{$Medicine->quantity}}' class="form-control" maxlength="30" id="quantity" name="quantity"  type="text" required>
                                    </div>
                              </div>
                            <br><br>
                                  <center>
